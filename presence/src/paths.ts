 ...
 * parents (`pages`) which only surface via their per-locale children.
 * Schemas without an entry here keep working; they just don't appear
 * in the sitemap or get hreflang siblings.
 */
